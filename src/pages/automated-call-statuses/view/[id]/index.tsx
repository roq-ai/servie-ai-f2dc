...
import { getAutomatedCallStatusById } from 'apiSdk/automated-call-statuses';
...
function AutomatedCallStatusViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Automated Call Status Detail View
          </Text>
          {hasAccess('automated_call_status', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/automated-call-statuses/edit/${data?.id}`} passHref legacyBehavior>
              <Button
          ...
          <>
            <Stack direction="column" spacing={2} mb={4}>
              ...
              <Flex alignItems="center">
                ...
                <Text fontSize="md" as="span" ml={3}>
                  {data?.call_time as unknown as string}
                </Text>
              </Flex>
              <Flex alignItems="center">
                <Text fontSize="lg" fontWeight="bold" as="span">
